...
public class CheckData {
    ...
    public void printStudentList(ArrayList<Student> studentList) {
        for (int i = 0; i < studentList.size(); i++) {
            ...
            System.out.println("AVG: " + studentList.get(i).getAvg());
    ...
    public void classification(ArrayList<Student> studentList) {
        ...
        System.out.println("A: " + aPercent + "%");
        System.out.println("B: " + bPercent + "%");
        System.out.println("C: " + cPercent + "%");
        System.out.println("D: " + dPercent + "%");
    }
}
