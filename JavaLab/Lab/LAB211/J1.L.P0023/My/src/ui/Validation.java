...
public class Validation {
    ...
    public static String checkInputName() {
        ...
        while (true) {
            ...
            if (result.isEmpty()) {
                ...
                System.out.println("Name is not number !");
                System.out.print("Enter name again: ");
            }
        }
    }

    public static String checkInputOrigin() {
        //loop until user input correct
        while (true) {
            String result = in.nextLine().trim();
            if (result.isEmpty()) {
                ...
                System.out.println("Origin is not number !");
                System.out.print("Enter origin again: ");
            }
        }
    }
    ...
    public static boolean checkItemExist(ArrayList<FruitOrder> lo, String id) {
