...
public class FormSwing1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtA1.setRows(5);
        txtA1.setText("The lady firefox");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormSwing1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormSwing1().setVisible(true);
            }
        });
    }
