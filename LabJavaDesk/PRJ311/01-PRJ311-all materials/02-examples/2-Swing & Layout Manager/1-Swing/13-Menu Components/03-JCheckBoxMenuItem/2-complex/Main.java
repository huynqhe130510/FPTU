...
class CheckBoxMenuItemExample extends JPanel
   { public JTextPane pane;
     ...
     public CheckBoxMenuItemExample()
        { menuBar = new JMenuBar();
          ...
          JCheckBoxMenuItem leftJustify = new  JCheckBoxMenuItem("Left", new ImageIcon("Icons/left.gif"));
          ...
          JCheckBoxMenuItem rightJustify = new  JCheckBoxMenuItem("Right", new ImageIcon("Icons/right.gif"));
          ...
          JCheckBoxMenuItem centerJustify = new  JCheckBoxMenuItem("Center", new ImageIcon("Icons/center.gif"));
          ...
          JCheckBoxMenuItem fullJustify = new JCheckBoxMenuItem("Full", new ImageIcon("Icons/full.gif"));
