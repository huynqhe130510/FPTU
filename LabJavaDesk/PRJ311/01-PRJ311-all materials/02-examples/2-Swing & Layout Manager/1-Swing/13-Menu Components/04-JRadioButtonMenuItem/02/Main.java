...
class RadioButtonMenuItemExample extends JPanel
        ...
        { menuBar = new JMenuBar();
          ...
          ActionListener actionPrinter = new ActionListener()
              { public void actionPerformed(ActionEvent e)
                   { try { pane.getStyledDocument().insertString(0 , "Action ["+e.getActionCommand()+"] performed!\n", null); }
                         catch (Exception ex) { ex.printStackTrace(); }
                   }
              };
          JRadioButtonMenuItem leftJustify = new  JRadioButtonMenuItem("Left", new ImageIcon("Icons/left.gif"));
          ...
          JRadioButtonMenuItem rightJustify = new  JRadioButtonMenuItem("Right", new ImageIcon("Icons/right.gif"));
          ...
          JRadioButtonMenuItem centerJustify = new JRadioButtonMenuItem("Center", new ImageIcon("Icons/center.gif"));
          ...
          JRadioButtonMenuItem fullJustify = new  JRadioButtonMenuItem("Full", new ImageIcon("Icons/full.gif"));
