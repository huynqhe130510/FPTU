...
public class Control {
    ...
    public void addButton() {
        ...
        pn.removeAll();
        pn.setLayout(new GridLayout(size, size, 5, 5));
        pn.setPreferredSize(new Dimension(size * 50, size * 50));
    ...
    public void moveButton(JButton btn) {
        ...
        btn.setText("");
        moveCount++;
        this.p.lblCountMove.setText(moveCount + "");
    }
