...
namespace Group6_Lab3.GUI
{
    public partial class BookGUI : Form
    {
        ...
        private void btnCopyEdit_Click(object sender, EventArgs e)
        {
            ...
            {
                c = new Copy(int.Parse(txtCopyBookNumber.Text), int.Parse(txtCopyNumber.Text), int.Parse(txtSequenceNumber.Text), txtType.Text[0].ToString(), double.Parse(txtPrice.Text));
