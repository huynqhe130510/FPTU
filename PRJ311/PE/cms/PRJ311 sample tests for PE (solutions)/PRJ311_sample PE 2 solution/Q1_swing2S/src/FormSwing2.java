 ...
 * @author CAUPD
 */
public class FormSwing2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        mnuItem1.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_O, java.awt.event.InputEvent.CTRL_MASK));
        mnuItem1.setText("Open");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormSwing2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormSwing2().setVisible(true);
            }
        });
    }
